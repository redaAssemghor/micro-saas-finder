  ...
  return (
    <div className="w-full min-h-screen inset-0 flex items-center justify-center bg-slate-700 text-center z-50 p-4 sm:p-8">
      <div className="text-white max-w-3xl mx-auto">
        ...
        <button className="bg-blue-500 text-white font-semibold py-2 sm:py-3 px-4 sm:px-6 rounded-lg hover:bg-blue-600 transition duration-300 text-base sm:text-lg md:text-xl">
          Find StartUp ideas
        </button>
      </div>
    </div>
